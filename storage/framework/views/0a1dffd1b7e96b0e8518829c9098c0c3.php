...
<body>
    <nav class="navbar navbar-dark bg-dark">
        <div class="container">
            ...
            <div>
                <span class="text-white me-3">Halo, <?php echo e(Auth::user()->name); ?> (Admin)</span>
    ...
    <div class="container mt-4">
        <div class="row mb-3">
            ...
            <div class="col-md-4 text-end">
                <a href="<?php echo e(route('admin.transactions.index')); ?>" class="btn btn-secondary btn-sm me-2">Lihat Transaksi</a>
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody id="itemsTableBody">
                            ...
                            <tr data-id="<?php echo e($item->id); ?>">
                                ...
                                <td>
                                    <button type="button" class="btn btn-warning btn-sm btn-edit" data-id="<?php echo e($item->id); ?>" data-kode="<?php echo e($item->kode); ?>" data-nama="<?php echo e($item->nama); ?>" data-stok="<?php echo e($item->stok); ?>">Edit</button>
                                    <button type="button" class="btn btn-danger btn-sm btn-delete" data-id="<?php echo e($item->id); ?>">Hapus</button>
                                </td>
                            </tr>
    ...
    <script>
        ...
        const indexUrl = "<?php echo e(route('admin.items.ajax.index')); ?>";
        const storeUrl = "<?php echo e(route('admin.items.ajax.store')); ?>";
        const updateBaseUrl = "<?php echo e(url('/admin/items/ajax')); ?>";
...
<?php /**PATH C:\laragon\www\PraktikumWeb\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>